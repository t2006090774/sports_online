    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.jsp">Siimple</a>
        </div>
					...
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner">
						<div class="item active">
						  <img src="${basePath}/img/slide1.png" alt="">
						</div>
						<div class="item">
						  <img src="${basePath}/img/slide2.png" alt="">
						</div>
						<div class="item">
						  <img src="${basePath}/img/slide3.png" alt="">
						</div>
					  </div>
					</div>		
				</div>
